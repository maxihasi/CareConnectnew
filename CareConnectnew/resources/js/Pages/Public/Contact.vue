...
-->
<body class="bg-green-200 text-gray-100 px-8 py-12">
    <h4>CareConnect</h4>
      <div
        class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-green-100 text-gray-900 rounded-lg shadow-lg">
        ...
        <div class="">
          <div>
            <label class="uppercase text-sm text-gray-600 font-bold" for="product_name">Full Name</label>
          ...
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold"for="product_name">Email</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text"
              id="product_name"
              v-model="form.email"
          ...
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold"for="product_name">Message</span>
            <textarea
          ...
          <div class="mt-8">
            <input
                        ...
                        @click="submit"
                        value="Send Message"
                       class="uppercase text-sm font-bold tracking-wide bg-green-400 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
                    />
          </div>
        </div>
      </div>
